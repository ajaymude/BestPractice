...
// JavaScript String Methods (Complete List)
...
// Character access
str.charAt(0)             // → character at index 0
str.charCodeAt(0)         // → Unicode of character at index 0
str.codePointAt(0)        // → Unicode code point (better for emojis)
str[0]                    // → direct access (same as charAt)

// Searching
str.indexOf("Java")       // → first index of "Java"
str.lastIndexOf("a")      // → last index of "a"
str.includes("Java")      // → true if "Java" is found
str.startsWith(" Hello")  // → true
str.endsWith("!")         // → true
str.search("Script")      // → index using regex
str.match(/Java/g)        // → matches regex, returns array
str.matchAll(/a/g)        // → iterator for all matches (ES2020+)

// Modifying
str.toUpperCase()         // → converts to upper case
str.toLowerCase()         // → converts to lower case
str.replace("Java", "Type")    // → replaces first match
str.replaceAll("a", "*")       // → replaces all (ES2021+)
str.normalize()           // → Unicode normalization

// Extracting
str.slice(1, 6)           // → substring from index 1 to 5
str.substring(1, 6)       // → similar to slice
str.substr(1, 5)          // → deprecated, use slice

// Whitespace trimming
str.trim()                // → removes both sides
...
str.split(" ")            // → splits into array
["Hello", "World"].join(" ")  // → joins into string

// Comparison
"abc" === "abc"           // → true (strict equality)
"abc".localeCompare("abd")   // → -1, 0, or 1 for sorting
